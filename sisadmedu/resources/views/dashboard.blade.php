...
@section('contenido')
    <div class="contenedor">
        ...
        <div class="contenedor-dashboard mb-4">
            @if (session('debe_cambiar_contrasena'))
                <div class="toast-container position-fixed top-0 end-0 p-3" style="z-index: 1100; max-width: 100%;">
                    <div class="toast show text-bg-light border-0 shadow-lg" role="alert" aria-live="assertive"
                        aria-atomic="true">

                        <!-- Toast body -->
                        <div
                            class="toast-body d-flex flex-column flex-wrap flex-md-row align-items-center justify-content-between gap-2">
                            ...
                            <div class="mt-1 d-flex justify-content-center gap-2">
                                <a href="{{ route('cambiar_contraseña') }}"
                                    class="btn boton-toast-contraseña btn-sm text-white">
        ...
        @if ($usuario->rol->nombre == 'Acudiente')
            <div class="module">
                <p class="module-title"><i class="fa-solid fa-user"></i> Mi Información</p>
                <p class="module-total">Consulta tu información y la de tus estudiantes</p>
                <a class="module-button" href="{{ route('acudiente.informacion') }}">
