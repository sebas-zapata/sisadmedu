    ...
    <div class="contenedor-dashboard mb-4">
        ...
        <div class="d-flex flex-wrap justify-content-center align-items-stretch gap-1">
            ...
            <div class="module">
                ...
                <p class="module-total">Consulta tu información y de los estudiantes</p>
            ...
            <div class="module">
                <p class="module-title"><i class="fa-solid fa-calendar"></i> Observaciones</p>
                <p class="module-total">Consultar las observaciones del estudiante</p>
                <a class="module-button" href="{{ route('acudiente.observaciones') }}">
                    <i class="fas fa-eye"></i> Ver Observaciones
                </a>
            </div>
            <div class="module">
